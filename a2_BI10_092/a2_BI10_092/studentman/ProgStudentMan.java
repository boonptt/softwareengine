...
import a2_BI10_092.kengine.Doc;
import a2_BI10_092.kengine.DocCnt;
import a2_BI10_092.kengine.Engine;
import a2_BI10_092.kengine.Query;
import utils.DOpt;
...
public class ProgStudentMan {
  ...
  if (words == null) throw new NotPossibleException("ProgStudentMan.search: key words cannot be NULL");
	if (words.length == 0) throw new NotPossibleException("ProgStudentMan.search: cannot find key word");
